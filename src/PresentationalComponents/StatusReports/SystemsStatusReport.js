...
const SystemsStatusreport = ({ metadata, apply }) => {

    let subtotals = React.useMemo(()=>{

        return metadata?.subtotals;
    }, [metadata.filter?.os?.values?.length, metadata?.subtotals !== undefined]);
